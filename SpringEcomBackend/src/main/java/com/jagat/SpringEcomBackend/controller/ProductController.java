...
import com.jagat.SpringEcomBackend.service.ProductService;
...
//    }
    ...
    @PostMapping("/product")
    public ResponseEntity<?> addProduct(@RequestPart Product product, @RequestPart MultipartFile imageFile){        //ResponseEntity<?> because we can either return a message or a product we use "?"
